# Dock Component — Full Source

Copy this file verbatim as `src/components/Dock.tsx`.
...
- `SuminagashiCanvasHandle` type from `SuminagashiCanvas.tsx`
- CSS classes: `.dock`, `.inks`, `.ink`, `.ink-cycle`, `.ink-sumi`, `.ink-ai`, `.ink-shu`, `.ink-matsuba`, `.lbl`, `.act` — see [css.md](css.md)
